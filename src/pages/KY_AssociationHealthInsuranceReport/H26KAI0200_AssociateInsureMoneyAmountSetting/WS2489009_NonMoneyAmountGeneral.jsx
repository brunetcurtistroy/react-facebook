...
import NonMoneyAmountGeneralAction from "redux/AssociationHealthInsuranceReport/AssociateInsureMoneyAmountSetting/NonMoneyAmountGeneral.sction";

class WS2489009_NonMoneyAmountGeneral extends React.Component {
  ...
  getScreenData() {
    ...
    NonMoneyAmountGeneralAction.getScreenData(param)
      .then((res) => {
        this.setState({
          dataSource: res,
  ...
  onSaveData(index) {
    ...
    NonMoneyAmountGeneralAction.updateRecord(param)
      .then(res => {
  ...
  render() {
    return (
      <div className="non-money-amount-general">
        <Card title="未金額一般">
...
export default connect(mapStateToProps, mapDispatchToProps)(WS2489009_NonMoneyAmountGeneral);
