...
import MoneyAmountAddedGeneralAction from "redux/AssociationHealthInsuranceReport/AssociateInsureMoneyAmountSetting/MoneyAmountAddedGeneral.action";

class WS2489007_MoneyAmountAddedGeneral extends React.Component {
  ...
  getScreenData() {
    ...
    MoneyAmountAddedGeneralAction.getScreenData(param)
      .then((res) => {
        this.setState({
          dataSource: res,
  ...
  onSaveData(index) {
    ...
    MoneyAmountAddedGeneralAction.updateRecord(param)
      .then(res => {
  ...
  render() {
    return (
      <div className="money-amount-added-general">
        <Card title="金額付加一般">
...
export default connect(mapStateToProps, mapDispatchToProps)(WS2489007_MoneyAmountAddedGeneral);
