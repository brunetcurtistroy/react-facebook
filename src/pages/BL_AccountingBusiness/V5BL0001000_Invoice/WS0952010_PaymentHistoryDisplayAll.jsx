...
class WS0952010_PaymentHistoryDisplayAll extends React.Component {
  static propTypes = {
  ...
  render() {
    return (
      <div className="payment-history-display-all">
        <Card title="入金履歴表示[全体]">
          <Table
          ...
          >
            <Table.Column title="請求先区分" dataIndex="Expression_4" />
            <Table.Column
              title="入金管理番号"
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(WS0952010_PaymentHistoryDisplayAll);
