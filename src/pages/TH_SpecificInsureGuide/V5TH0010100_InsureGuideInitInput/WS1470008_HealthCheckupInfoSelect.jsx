...
class WS1470008_HealthCheckupInfoSelect extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(WS1470008_HealthCheckupInfoSelect);
