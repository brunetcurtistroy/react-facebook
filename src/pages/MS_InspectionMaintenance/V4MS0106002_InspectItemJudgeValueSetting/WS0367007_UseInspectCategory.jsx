...
import UseInspectCategoryAction from 'redux/InspectionMaintenance/InspectItemJudgeValueSetting/UseInspectCategory.actions'
import moment from 'moment';
import  ModalDraggable  from "components/Commons/ModalDraggable";

class WS0367007_UseInspectCategory extends React.Component {
  static propTypes = {
  ...
  GetScreenData() {
    ...
    UseInspectCategoryAction.GetScreenData(obj).then(res => {
      this.setState({
  ...
  Run_F12(){
    ...
    this.setState({loadding: true}) 
    UseInspectCategoryAction.Run_F12(obj).then(res=>{  
  ...
  render() {
    return (
      <div className="use-inspect-category">
        <Card title="使用検査[カテゴリ]">
...
export default connect(mapStateToProps, mapDispatchToProps)(WS0367007_UseInspectCategory);
