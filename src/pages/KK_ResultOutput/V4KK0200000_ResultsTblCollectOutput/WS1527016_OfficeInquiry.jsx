...
import OfficeInquiryAction from "redux/ResultOutput/ResultsTblCollectOutput/SetupResultTblCollectOutput/WS1527016_OfficeInquiry/OfficeInquiry.action.js";
class WS1527016_OfficeInquiry extends React.Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, mapDispatchToProps)(WS1527016_OfficeInquiry);
