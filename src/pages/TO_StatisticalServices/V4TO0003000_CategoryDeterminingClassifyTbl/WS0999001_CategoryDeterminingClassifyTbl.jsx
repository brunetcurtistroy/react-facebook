...
class WS0999001_CategoryDeterminingClassifyTbl extends React.Component {
  ...
  constructor(props) {
    ...
    // document.title = 'V4-VNS60500:カテゴリ判定分類表';
  ...
  render() {
    ...
    return (
      <div className="category-determining-classify-tbl">
        <Card title="V4-VNS60500:カテゴリ判定分類表">
        <Form
            ref={this.formRef}
          ...
          >
            <div style={{display:'none'}}>
              ...
              <Form.Item name="WrkGroupCdFrom"><Input /></Form.Item>
              <Form.Item name="WrkGroupCdTo"><Input /></Form.Item>
            ...
            <div style={{ border: '1px solid rgba(0, 0, 0, 0.06)', padding: '0.5em' }}>
              ...
              <Space>
                <Form.Item name="GgroupCode" label="&emsp;ｶﾃｺﾞﾘ">
...
export default connect(mapStateToProps, mapDispatchToProps)(WS0999001_CategoryDeterminingClassifyTbl);
