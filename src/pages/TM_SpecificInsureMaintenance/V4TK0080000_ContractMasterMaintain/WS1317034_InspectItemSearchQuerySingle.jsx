...
class WS1317034_InspectItemSearchQuerySingle extends React.Component {
  static propTypes = {
    Lio_InspectItemCode: PropTypes.any,
    Li_UnusedInspectDisplay: PropTypes.any,
    Li_SpecificMedicalExam: PropTypes.any, 
...
handleButton = () => {
  if(this.props.onFinishScreen){
    this.props.onFinishScreen({Lio_InspectItemCode:  this.formRef.current?.getFieldValue("selectedRow")?.test_item_code,
...
export default connect(mapStateToProps, mapDispatchToProps)(WS1317034_InspectItemSearchQuerySingle);
