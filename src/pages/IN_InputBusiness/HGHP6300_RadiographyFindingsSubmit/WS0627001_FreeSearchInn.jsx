...
class WS0627001_FreeSearchInn extends React.Component {
  formRef = React.createRef();

  constructor(props) {
    super(props);

    // document.title = '空き検索(宿)';
...
export default connect(mapStateToProps, mapDispatchToProps)(WS0627001_FreeSearchInn);
